...
class PageUserPermissions:
    ...
    def paths_user_permissions(self):
        ...
        self.english_auth_create_client = self.wait.until(EC.visibility_of_element_located((By.XPATH, "//*[contains(text(), 'Create Auth Clients')]")))
        self.english_auth_delete_client = self.wait.until(EC.visibility_of_element_located((By.XPATH, "//*[contains(text(), 'Delete Auth Clients')]")))
        self.english_auth_edit_client = self.wait.until(EC.visibility_of_element_located((By.XPATH, "//*[contains(text(), 'Edit Auth-Clients')]")))
        self.english_auth_see_client = self.wait.until(EC.visibility_of_element_located((By.XPATH, "//*[contains(text(), 'View Auth-Clients')]")))
