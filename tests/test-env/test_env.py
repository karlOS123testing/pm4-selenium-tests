...
class TestEnv(BaseTest):
    ''' Navigate to the Requests page. '''

    def test_that_environment_check_works(self):
        ''' Verify that ENV variable passed to Docker container works as a test for environment.'''
...
if __name__ == "__main__":
    import __main__
    output = run_test(TestEnv, data, __main__)
