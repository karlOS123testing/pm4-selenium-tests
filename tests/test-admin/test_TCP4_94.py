...
class TestNewAuthClientNameInputField(BaseTest):
    ...
    def test_that_new_auth_client_name_input_field_accepts_long_strings(self):
        ...
        # Click +Auth Client button and wait for name element on form to be visible
...
if __name__ == "__main__":
    import __main__
    output = run_test(TestNewAuthClientNameInputField, data, __main__)
