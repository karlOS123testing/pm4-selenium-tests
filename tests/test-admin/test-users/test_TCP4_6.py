...
""" Class to test the new user confirm password field.
"""
...
class TestNewUserConfirmPasswordInputField(BaseTest):
    ''' Navigate to the Users page, create new user and test the confirm password input field. '''

    def test_that_new_user_confirm_password_input_field_accepts_long_strings(self):
        ''' Verify that a string 61+ characters long will be accepted in the new user confirm password input field.'''
...
if __name__ == "__main__":
    import __main__
    output = run_test(TestNewUserConfirmPasswordInputField, data, __main__)
