...
class TCP4_623(BaseTest):
    ...
    def test_tcp4_623(self):
        ...
        # Wait for user edit form to load, changes the timezone and save
        self.wait.until(EC.visibility_of_element_located((By.ID, 'firstname')))
        dropdown = Select(self.driver.find_element_by_id('timezone'))
        ...
        self.assertEquals(option.text, 'Africa/Asmara')
