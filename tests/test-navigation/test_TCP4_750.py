...
""" Class to ensure Screens page loads.
"""
...
class TestScreensPageLoads(BaseTest):
    ''' Navigate to the Screens page from Designer page. '''

    def test_that_screens_page_loads(self):
        ''' Verify that Screens page loads.'''
        ...
        # Wait for Screens button to be clickable and click button
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//i[@class='fas nav-icon fa-file-alt']")))
        self.driver.find_element_by_xpath("//i[@class='fas nav-icon fa-file-alt']").click()

        # Verify Screens page elements have loaded
...
if __name__ == "__main__":
    import __main__
    output = run_test(TestScreensPageLoads, data, __main__)
